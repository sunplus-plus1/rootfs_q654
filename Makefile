...
initramfs:
	@cd initramfs; export ARCH=$(ARCH); export CROSS=$(CROSS); export ROOTFS_CONTENT=$(ROOTFS_CONTENT); export boot_from=$(boot_from); export OVERLAYFS=${OVERLAYFS}; BOARDNAME=${BOARDNAME} ./build_disk.sh ${rootfs_cfg}; cd -
